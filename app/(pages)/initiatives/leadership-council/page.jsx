              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input id="businessActivity" placeholder="Your business activity" />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <Textarea id="businessInterest" placeholder="Describe your business interests" />
                </div>

                <div>
                  <Label htmlFor="products">Details of Products & Services to promote amongst SMEs *</Label>
                  <Textarea id="products" placeholder="Describe your products and services" />
                </div>
                ...
                <div>
                  ...
                  <Textarea id="address" placeholder="Your complete address" />
                </div>

                <Button className="w-full bg-[#29688A] hover:bg-[#1e4d66] text-white py-3 text-lg">
                  Submit Application
                </Button>
              </CardContent>
            </Card>
